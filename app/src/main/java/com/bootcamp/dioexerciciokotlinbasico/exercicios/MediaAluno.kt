...
fun main() {
    ...
    println("Digite com a primeira nota: ")
    val n1 = entrada.nextFloat()

    println("Digite com a segunda nota: ")
    val n2 = entrada.nextFloat()

    println("Digite com a terceira nota: ")
    val n3 = entrada.nextFloat()

    println("Digite com a quarta nota: ")
    val n4 = entrada.nextFloat()

    val media: Float

    val mediaPonderada =
        (n1 * peso1 + n2 * peso2 + n3 * peso3 + n4 * peso4) / (peso1 + peso2 + peso3 + peso4)
